...
const SHEET_INCUBATOR = {
  ...
  features: [
    ...
    { fa: "گردش موثر هوای محفظه و گرمایش یکنواخت در تمام جهات", en: "Effective air circulation and uniform heating in all directions" },
...
const SHEET_VP200 = {
  ...
  features: [
    ...
    { fa: "قابلیت استفاده دوگانه (دارای حالت دیسپنسینگ)", en: "Dual-use capability (dispensing mode)" },
    { fa: "طراحی ویژه و تنظیم بازگشت (تقسیم مایعات بدون چکه)", en: "Special design and retraction setting (drip-free dispensing)" },
