...
const CATALOGS = [
  ...
  {
    id: "peristaltic-pump",
    name: { fa: "پمپ‌های پریستالتیک سینا", en: "Sina Peristaltic Pumps" },
    tagline: { fa: "چهار مدل برای کاربردهای آزمایشگاهی و صنعتی", en: "Four models for lab and industrial use" },
    accent: "#7c3aed",
    cover: "assets/img/products/vp200.jpg",
    sheets: [SHEET_VP200, SHEET_DG6, SHEET_SF15, SHEET_SP15],
  },
];
